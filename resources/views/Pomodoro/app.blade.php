...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="settings-panel">
            ...
            <div id="settings-panel-inner">
                ...
                <h3>Theme</h3>
                <div>
                    <input type="radio" id="select-theme-default" name="select-theme" value="default"
    ...
    <div style="position: fixed; bottom: 180px; left: 50%; transform: translateX(-50%);">
        <a href="{{ URL::previous() }}"
            style="display: inline-block; padding: 10px 20px; background-color: #337ab7; color: #fff; text-decoration: none; border-radius: 5px;">Done Working?</a>
    </div>
